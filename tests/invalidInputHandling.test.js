...
describe('Comprehensive Invalid Input Handling Tests', () => {
  ...
  describe('ChessGame Invalid Input Handling', () => {
    ...
    test('should handle invalid promotion piece types', () => {
      ...
      const invalidPromotions = ['king', 'pawn', 'invalid', '', null, undefined, 123, true, [], {}];
    ...
    test('should handle extremely large objects as coordinates', () => {
      ...
      const result = game.makeMove(largeObject, {
        row: 1,
        col: 1
      });
      // Should fail due to no piece at source or invalid move
  ...
  describe('GameStateManager Invalid Input Handling', () => {
    test('should handle invalid game status updates', () => {
      const invalidStatuses = [null, undefined, '', 'invalid', 123, true, [], {}, 'ACTIVE', 'Check'];
    ...
    test('should handle invalid turn sequence validation', () => {
      const invalidColors = [null, undefined, '', 'red', 'blue', 'WHITE', 'BLACK', 123, true, [], {}];
    ...
    test('should handle invalid board consistency validation', () => {
      const invalidBoards = [null, undefined, [], 'invalid', Array(7).fill(null).map(() => Array(8).fill(null)),
      // Wrong size
    ...
    test('should handle invalid game state consistency validation', () => {
      const invalidGameStates = [null, undefined, {
  ...
  describe('GameManager Invalid Input Handling', () => {
    test('should handle invalid game creation parameters', () => {
      const invalidParams = [null, undefined, '', 123, true, [], {}, 'a',
      // Too short
  ...
  describe('API Endpoint Invalid Input Handling', () => {
    test('should handle malformed JSON in move requests', () => {
      const malformedJsonStrings = ['{"from":{"row":0,"col":0},"to":{"row":1,"col":1}',
      // Missing closing brace
      '{"from":{"row":0,"col":0},"to":{"row":1,"col":1}}extra',
      // Extra characters
      '{"from":{"row":0,"col":0},"to":{"row":1,"col":1},}',
      // Trailing comma
      '{"from":{"row":0,"col":0},"to":{"row":1,"col":1},"invalid":}',
      // Missing value
      '{from:{"row":0,"col":0},"to":{"row":1,"col":1}}',
      // Unquoted key
    ...
    test('should handle SQL injection attempts in string fields', () => {
      const sqlInjectionAttempts = ["'; DROP TABLE games; --", "' OR '1'='1", "'; DELETE FROM users; --", "' UNION SELECT * FROM passwords --", "<script>alert('xss')</script>", "javascript:alert('xss')"];
  ...
  describe('Type Coercion and Edge Cases', () => {
    ...
    test('should handle buffer overflow attempts', () => {
      const bufferOverflowAttempts = ['A'.repeat(100000),
      // Large string (reduced size for test performance)
      '\x00'.repeat(1000),
      // Null bytes
