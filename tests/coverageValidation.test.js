...
describe('Coverage Validation Tests - Ensuring 95% Code Coverage', () => {
  ...
  describe('ChessGame Class Coverage', () => {
    ...
    test('should cover all special move scenarios', () => {
      ...
      const exd5Result = game.makeMove({
        from: {
          row: 4,
          col: 4
        },
  ...
  describe('Error Handler Coverage', () => {
    test('should cover all error types', () => {
      const errorTypes = ['INVALID_COORDINATES', 'NO_PIECE', 'WRONG_TURN', 'INVALID_MOVEMENT', 'KING_IN_CHECK', 'GAME_NOT_ACTIVE', 'INVALID_PIECE', 'PATH_BLOCKED', 'INVALID_CASTLING', 'INVALID_EN_PASSANT', 'INVALID_PROMOTION'];
  ...
  describe('Edge Case Coverage', () => {
    ...
    test('should cover null and undefined handling', () => {
      const nullUndefinedCases = [null, undefined, {
        from: null,
        to: {
          row: 0,
          col: 0
